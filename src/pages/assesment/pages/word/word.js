...
const dataByAgeGroup = {
  '0-4': ['apple', 'ball', 'cat', 'dog', 'fish', 'duck', 'hat', 'sun', 'moon', 'star'],
  '4-10': ['computer', 'television', 'keyboard', 'guitar', 'elephant', 'dinosaur', 'bicycle', 'robot', 'carrot', 'giraffe'],
  '10-16': ['chemistry', 'astronomy', 'biology', 'algebra', 'history', 'literature', 'geometry', 'physics', 'geography', 'language'],
  '16-24': ['university', 'entrepreneur', 'innovation', 'technology', 'leadership', 'revolution', 'programming', 'disruption', 'startup', 'blockchain'],
};
...
const WordGame = () => {
  ...
  const onLetterClick = (index) => {
    ...
    if (clickedLetter.isClicked) {
      ...
      setChosenLetters(chosenLetters.filter((chosenLetter) => chosenLetter !== letter));
    }
